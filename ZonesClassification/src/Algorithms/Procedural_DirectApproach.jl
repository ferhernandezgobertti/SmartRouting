...
"""
    ProDirectApproach <: AbstractClassificationAlgorithm
...
struct ProDirectApproach <: AbstractClassificationAlgorithm end
...
function solve(alg::ProDirectApproach, trainroutes::Vector{Route}, valroutes::Vector{Route})
...
function solve(alg::ProDirectApproach, valroutes::Vector{Route}, zclust::ZonesCluster)
    dParams = [20, 150, 1, 0.0004, 0.0007, 0.00005, 0.004, 0.001, 2, 1]
    return solve(alg, valroutes, zclust; params=dParams)
end

function solve(alg::ProDirectApproach, routes::Vector{Route}, zones_cluster::ZonesCluster; params)
