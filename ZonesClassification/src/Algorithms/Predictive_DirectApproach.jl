...
"""
    PreDirectApproach <: AbstractClassificationAlgorithm
...
established zones relative to the training routes.
...
struct PreDirectApproach <: AbstractClassificationAlgorithm end
...
function solve(alg::PreDirectApproach, trainroutes::Vector{Route}, valroutes::Vector{Route})
...
function solve(alg::PreDirectApproach, valroutes::Vector{Route}, zclust::ZonesCluster)
    dParams = [20, 150, 1, 0.0004, 0.0007, 0.00005, 0.004, 0.001, 2, 1, 3, 1.2, 2, 1.5, 1.2, 1.4]
    return solve(alg, valroutes, zclust; params=dParams)
end

function solve(alg::PreDirectApproach, routes::Vector{Route}, zones_cluster::ZonesCluster; params)
