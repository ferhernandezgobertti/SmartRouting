...
"""
    DirectApproach <: AbstractIdentificationAlgorithm
...
struct DirectApproach <: AbstractIdentificationAlgorithm end
...
function solve(alg::DirectApproach, trainroutes::Vector{Route}, valroutes::Vector{Route})
    ...
    dParams = [2.2, 1.5, 1.7, 1.3, 0.614, 0.231, 0.245, 0.089, 5, -3, 4, 1, 2, 0]
...
function solve(alg::DirectApproach, routes::Vector{Route}, zvar::ZonesVar; params=dParams)
