"""
    BackwardApproach <: AbstractDeterminationAlgorithm

Algorithm that determines the stops from raw GPS registries while looking backward 
...
struct BackwardApproach <: AbstractDeterminationAlgorithm end
...
function solve(alg::BackwardApproach, filenames::Vector{String}, is_time_american::Bool)
